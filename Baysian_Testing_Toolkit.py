...
with col1:
    ...
    # Use a standard markdown link for navigation
    st.link_button("Open the Estimator", "/Uplift_Certainty_Estimator", type="primary")
...
with col2:
    ...
    # Use a standard markdown link for navigation
    st.link_button("Open the Calculator", "/Sample_Size_Calculator", type="primary")
...
with col3:
    ...
    # Use a standard markdown link for navigation
    st.link_button("Open the Simulator", "/False_Positive_Simulator", type="primary")
